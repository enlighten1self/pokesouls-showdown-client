...
const BattlePokemonIconIndexes: {[id: string]: number} = {
	...
	clefablemega: 1512 + 184,
	victreebelmega: 1512 + 185,
	starmiemega: 1512 + 186,
	dragonitemega: 1512 + 187,
	meganiummega: 1512 + 188,
	feraligatrmega: 1512 + 189,
	skarmorymega: 1512 + 190,
	froslassmega: 1512 + 191,
	excadrillmega: 1512 + 192,
	chandeluremega: 1512 + 193,
	floettemega: 1512 + 194,
	hawluchamega: 1512 + 195,
	drampamega: 1512 + 196,
	chimechomega: 1512 + 197,
	golurkmega: 1512 + 198,
	meowsticmega: 1512 + 199,
...
class Move implements Effect {
	...
	constructor(id: ID, name: string, data: any) {
		...
		this.pp = data.pp || 1;
		this.ppOverride = data.ppOverride || null;
		this.type = data.type || '???';
